...
static const char *FNAME = "tm_context.c";
...
int init_tm_context(tm_context *cxt)
{
	...
	((tm_amplifier_str*)cxt->output_amp.data_struct)->gain.value = 0.0;
	((tm_amplifier_str*)cxt->output_amp.data_struct)->gain.old_value = 0.0;
	((tm_amplifier_str*)cxt->output_amp.data_struct)->gain.new_value = 1.0;
	((tm_amplifier_str*)cxt->output_amp.data_struct)->gain.updated = 1;
...
int cxt_update_setting_value_by_id(tm_context *cxt, uint16_t pid, uint16_t tid, uint16_t oid, uint16_t new_value)
{
	...
	tm_setting *setting = cxt_get_setting_by_id(cxt, pid, tid, oid);
...
panic_bypass:
	...
	tm_printf("cxt_process: alloc fail!!\n");
