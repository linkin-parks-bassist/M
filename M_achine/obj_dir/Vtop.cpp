...
Vtop::Vtop(VerilatedContext* _vcontextp__, const char* _vcname__)
    ...
    , clk{vlSymsp->TOP.clk}
    , rst{vlSymsp->TOP.rst}
    , tb_tx_valid{vlSymsp->TOP.tb_tx_valid}
    , tb_tx_ready{vlSymsp->TOP.tb_tx_ready}
    , tb_rx_valid{vlSymsp->TOP.tb_rx_valid}
    , tb_rx_ready{vlSymsp->TOP.tb_rx_ready}
    , tb_tx_sample_l{vlSymsp->TOP.tb_tx_sample_l}
    , tb_tx_sample_r{vlSymsp->TOP.tb_tx_sample_r}
    , tb_rx_sample_l{vlSymsp->TOP.tb_rx_sample_l}
    , tb_rx_sample_r{vlSymsp->TOP.tb_rx_sample_r}
    , rootp{&(vlSymsp->TOP)}
{
