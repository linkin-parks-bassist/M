...
VL_INLINE_OPT void Vpipeline_pipeline_block___nba_sequent__TOP__pipeline__DOT__blocks__BRA__63__KET____DOT__block_inst__0(Vpipeline_pipeline_block* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vpipeline_pipeline_block___nba_sequent__TOP__pipeline__DOT__blocks__BRA__63__KET____DOT__block_inst__0\n"); );
    ...
    if (((IData)(vlSymsp->TOP.instr_write) & (0x3fU 
