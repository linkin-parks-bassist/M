...
VL_ATTR_COLD void Vpipeline_pipeline_block__NB10___eval_static__TOP__pipeline__DOT__blocks__BRA__0__KET____DOT__block_inst(Vpipeline_pipeline_block__NB10* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vpipeline_pipeline_block__NB10___eval_static__TOP__pipeline__DOT__blocks__BRA__0__KET____DOT__block_inst\n"); );
...
VL_ATTR_COLD void Vpipeline_pipeline_block__NB10___stl_sequent__TOP__pipeline__DOT__blocks__BRA__0__KET____DOT__block_inst__0(Vpipeline_pipeline_block__NB10* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vpipeline_pipeline_block__NB10___stl_sequent__TOP__pipeline__DOT__blocks__BRA__0__KET____DOT__block_inst__0\n"); );
    Vpipeline__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
VL_ATTR_COLD void Vpipeline_pipeline_block__NB10___ctor_var_reset(Vpipeline_pipeline_block__NB10* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vpipeline_pipeline_block__NB10___ctor_var_reset\n"); );
    Vpipeline__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    ...
    vlSelf->mul_req_x = VL_RAND_RESET_I(16);
    vlSelf->mul_req_y = VL_RAND_RESET_I(16);
