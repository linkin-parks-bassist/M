#ifndef EM_TRANSFORMER_WIDGET_H_
#define EM_TRANSFORMER_WIDGET_H_

#define TRANSFORMER_WIDGET_HEIGHT 	70
...
int transformer_widget_untether(em_transformer_widget *tw);
int transformer_widget_retether(em_transformer_widget *tw);
